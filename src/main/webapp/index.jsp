...
<head>
    ...
    <link rel="icon" type="image/png" href="${ctx}/components/amazeui/i/favicon.png">
...
<header class="am-topbar am-topbar-inverse admin-header">
    ...
    <div class="am-collapse am-topbar-collapse" id="topbar-collapse">
        ...
        <ul class="am-nav am-nav-pills am-topbar-nav am-topbar-right admin-header-list tpl-header-list">
            ...
            <li><a href="javascript:" onclick="returnLogin()" class="tpl-header-list-link"><span class="am-icon-sign-out tpl-header-list-ico-out-size"></span>登出</a></li>
        </ul>
    </div>
</header>
...
<%--                <li class="tpl-left-nav-item">
                ...
                <li class="tpl-left-nav-item">
                    <a class="nav-link tpl-left-nav-link-list active" onclick="switchPage(2,this)" >
...
<%--                        <i class="tpl-left-nav-content tpl-badge-danger">
                ...
                <li class="tpl-left-nav-item">
                    <a id="opreation_a" class="nav-link tpl-left-nav-link-list" onclick="switchPage(3,this)">
                        <i class="am-icon-calculator"></i>
                        <span>操作日志</span>
<%--                        <i class="tpl-left-nav-content tpl-badge-danger">
                            1
                        </i>--%>
...
<%--                <li class="tpl-left-nav-item">
    ...
    <div class="tpl-content-wrapper">
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 数据表格
                    </div>
                ...
                <div class="tpl-block">
                        ...
                        <div class="am-u-sm-12 am-u-md-6">
                            <div class="am-btn-toolbar">
                                <div class="am-btn-group am-btn-group-xs">
                                    <button type="button" class="am-btn am-btn-default am-btn-warning" id="addClassify" onclick="initClassify()"><span class="am-icon-plus"></span>新增分类</button>
                                    <button type="button" class="am-btn am-btn-default am-btn-success" id="addPro" onclick="initAddData()"><span class="am-icon-plus"></span>新增数据</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="am-g">
                        <div class="am-u-sm-12">
                            <table id="table_id_example" class="am-table am-table-striped am-table-bordered display" style="width: 100%">
                                <thead>
                                <tr>
                                    <th >ID</th>
                                    <th >团队名</th>
                                    ...
                                    <th >xxxl</th>
                                    <th>MENO</th>
                                    <th style="width: 20%!important;">操作</th>
                                </tr>
                                <tbody></tbody>
                                <!-- tbody是必须的 -->
                                </thead>
        ...
        <div id="operationLogs" style="display: none">
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                ...
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="am-u-sm-12">
                            <table id="table_operationLogs" class="am-table am-table-striped am-table-bordered display" style="width: 100%">
                                <thead>
                                <tr>
                                    <th >ID</th>
                                    <th >时间</th>
