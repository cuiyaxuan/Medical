$(function () {
    initTableDepartmentRecordSeal();
});

function initTableDepartmentRecordSeal() {
    $('#table_department_record_seal').DataTable({
        ajax: {  //ajax方式向后台发送请求
            "type": "POST",
            "async":false,
        ...
        fnInitComplete:function (oSettings, json) {
            $('#table_department_record_seal').addClass('table-layout-fixed');
            $('#table_department_record_seal td:not(:last-of-type)').addClass("text-one-line");
